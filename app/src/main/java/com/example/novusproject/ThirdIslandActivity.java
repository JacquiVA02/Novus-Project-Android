...
public class ThirdIslandActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_third_island);
        ...
        */
        ...
        if (user != null) {
            ...
            startActivity(new Intent(ThirdIslandActivity.this, SesionActivity.class));
            finish();
            return;
        }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ThirdIslandActivity.this, MapaActivity.class);
    ...
    private void verificarAvance() {
        ...
        if (user != null) {
            ...
            DocumentReference userDocRef = db.collection("UsuarioTercera").document(userId);
