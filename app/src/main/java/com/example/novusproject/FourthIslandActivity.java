...
public class FourthIslandActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fourth_island);
        ...
        */
        ...
        if (user != null) {
            ...
            startActivity(new Intent(FourthIslandActivity.this, SesionActivity.class));
            finish();
            return;
        }
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FourthIslandActivity.this, MapaActivity.class);
    ...
    private void verificarAvance() {
        ...
        if (user != null) {
            ...
            DocumentReference userDocRef = db.collection("UsuarioCuarta").document(userId);
